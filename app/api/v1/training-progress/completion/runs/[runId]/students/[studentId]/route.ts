...
import { requireCompletionRunPermission, requireStudentPermission } from "@/lib/auth/data-scope";
...
export async function GET(request: NextRequest, { params }: Params) {
  try {
    ...
    const result = await TrainingProgressService.getCompletionStudentDetail(runId, studentId);
